...
from procedure.config import ConfigStore, MongodbConfig, RabbitMQConfig
...
def main(debug_flag=True):
    ...
    set_init_task([{TaskKey.mongodb: MongodbConfig()}, {TaskKey.rabbitmq_async: RabbitMQConfig()}])
